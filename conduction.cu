...
int main(void)
{
	...
	HANDLE_ERROR( cudaBindTexture2D( nullptr, texConstSrc, data.dev_constSrc, desc, DIM, DIM, sizeof(float) * DIM ) );
	HANDLE_ERROR( cudaBindTexture2D( nullptr, texIn, data.dev_inSrc, desc, DIM, DIM, sizeof(float) * DIM ) );
	HANDLE_ERROR( cudaBindTexture2D( nullptr, texOut, data.dev_outSrc, desc, DIM, DIM, sizeof(float) * DIM ) );
